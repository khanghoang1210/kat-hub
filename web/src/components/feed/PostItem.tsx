  ...
  return (
    <div className="p-3 bg-white-900 rounded-lg shadow w-5/12 left-[365px] top-32 relative mt-4">
      <div className="flex items-center mb-2 h-11">
        ...
        />
        <div className="ml-3">
          <h2 className="text-sm font-medium text-black-900">{username}</h2>
          <p className="text-xs text-black-800">{userTitle}</p>
        </div>
        <span className="ml-auto text-xs text-black-400">{postTime}</span>
      </div>
      <div className="relative flex py-1 items-center w-full">
        <div className="flex-grow border-t border-white-200"></div>
      </div>
      <div className="">
        <p className="mb-4 text-black-800 font-normal break-words">{postContent}</p>
      </div>
